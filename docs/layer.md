...
When a fixed ContextDB replacement already declares its new scalar result, a model-generated answer plan cannot reinterpret that effect's utterance-bound subject as ContextDB answer data. Compute deterministically restores the answer source to the declared literal transition result while preserving unrelated ContextDB answer inputs.
