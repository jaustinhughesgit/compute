...
"\n\nExample 7: Create a form that post an email. if it matches austin@1var.com then response with Welcome Austin, else let them try again. {\"blocks\": [{\"entity\": \"1v4rbef82e55-d90f-4d3d-9ea5-d72c4cc76685\",\"width\": \"100\",\"align\": \"center\"}],\"modules\": {},\"actions\": [{\"set\": {\"var\": \"{|body=>email|}\"}},{\"if\": [[\"{|var|}\",\"==\",\"austin@1var.com\"]],\"target\": \"res\",\"chain\": [{\"access\": \"send\",\"params\": [\"Welcome Austin!\"]}],\"assign\": \"{|posted|}!\"},{\"target\": \"{|res|}\",\"chain\": [{\"access\": \"send\",\"params\": [\"<form action='{|urlpath|}' method='post'><label for='email'>Email:</label><input type='email' id='email' name='email' required><input type='submit' value='Submit'></form>\"]}],\"assign\": \"{|form|}!\"}]}"
