...
async function convertToJSON(fileID, parentPath = [], isUsing, mapping, dynamodb, pathID) {
    ...
    if (using){
        ...
        const headUsingObj  = await convertToJSON(subOfHead.Items[0].su, paths[fileID], true, entity.Items[0].m, dynamodb, pathID)
