...
async function convertToJSON(fileID, parentPath = [], isUsing, mapping, dynamodb, uuidv4, pathID, parentPath2 = [], id2Path = {}, usingID = "") {
    ...
    obj[fileID] = {meta: {name: name, expanded:false, head:subH.Items[0].su},children: {}, using: using, linked:{}, pathid:pathID, usingID:usingID};
    let paths = {}
    let paths2 = {}
    //if (!pathID){
    //}
   ...
   // console.log("route")
    ...
    if (req.method === 'GET' || req.method === 'POST'){
        ...
        if (action == "file"){
            //console.log("file2")
            const expires = 90000;
            const url = "https://private.1var.com/actions/"+actionFile+".json";
