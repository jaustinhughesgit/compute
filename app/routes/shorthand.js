/**
 * Platform: Compatibility mirror of the active Shorthand matrix runtime for older direct imports.
 * Technical: Accepts the same matrix document and positional route/AWS context as `routes/modules/shorthand.js`.
 */
