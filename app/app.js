        ...
        if (runAction) {
            ...
            if (action.while) {
                ...
                for (const whileCondition of action.while) {
                    ...
                    console.log("---2", condition(await replacePlaceholders(whileCondition[0], libs, nestedPath), [{ condition: whileCondition[1], right: await replacePlaceholders(whileCondition[2], libs, nestedPath) }], null, "&&", libs, nestedPath))
